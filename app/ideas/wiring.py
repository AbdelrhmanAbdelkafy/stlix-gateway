...
WIRING: dict[str, Wire] = {
    ...
    # طبقة الذكاء نفسها.
    "A4": _w("ai nama", "overview", "sys ws",
             "طبقة الذكاء (Layer 4) — المصادر كلها موجودة، الناقص المحرّك اللي يقرا منها"),
    "A5": _w("ai nama rep archive", "overview", "sys ws",
             "فهرسة المصادر: الخريطة والوثائق موجودة · ناقص كتالوج الـ599 كيان وطبقة الذكاء"),
    "A6": _w("ai", "overview", "",
             "قراءة الصور (vision) — محتاجة مورّد طبقة الذكاء"),
    "A7": _w("ai", "overview", "",
             "الصوت العربي — نفس مورّد الذكاء، وبيتقاطع مع UX3"),
    "A8": _w("ai", "overview", "sys",
             "قاعدة الاستشهاد بالمصدر — بتتفرض في تصميم الخبير، مش feature منفصلة"),
    "A9": _w("ai rep", "overview", "",
             "الاقتراح بدل التنفيذ — متوقف على Layer 5 وآلية التوقيع"),
