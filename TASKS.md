...
- ✅ **كل شاشة على داتا لايف** — الكوكبيت اتعاد بناؤه: 7 أقسام كل واحد من endpoint حيّ
  (عملاء · موردين · بنوك · فواتير مشتريات · قيود يومية · تحصيلات · مدفوعات) + تاب «مستني إيه»
  للخمسة اللي مالهمش داتا. **مافيش رقم مخترع في أي صفحة موصّلة**، واختبار بيقفل القاعدة.
  المتصفح مابيجمّعش فلوس — المجاميع من `/api/v1/finance/*` المتطابق.
